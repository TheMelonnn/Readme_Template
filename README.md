...
<details>
  ...
  <ol>
    <li>
      <a href="#about-the-project">Pendahuluan</a>
      <ul>
        <li><a href="#built-with">Dibangun Dengan</a></li>
      </ul>
    </li>
    <li>
      <a href="#getting-started">Hal yang Perlu Disiapkan</a>
      <ul>
        <li><a href="#prerequisites">Prerequisites</a></li>
        <li><a href="#installation">Instalasi</a></li>
      </ul>
    </li>
    <li><a href="#usage">Kegunaan</a></li>
    <li><a href="#roadmap">Roadmap</a></li>
    <li><a href="#contact">Kontak</a></li>
    <li><a href="#acknowledgments">Daftar Referensi</a></li>
  </ol>
</details>
